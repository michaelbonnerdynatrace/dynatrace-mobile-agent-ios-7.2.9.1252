...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Generate SSL Pins.')
    ...
    if not args.certificate:
        ...
        with open(args.certificate, 'rb') as certFile:
    ...
    print(p1.communicate(input=certificate)[0].decode("utf-8"))
    ...
    hpkp_pin = base64.b64encode(spki_hash).decode("utf-8")

    print('\n---------------------- DTXDomainPins item ----------------------')
    print('DTXPKHash: {}'.format(hpkp_pin))
    print('DTXPKHashAlgoritm: {}\n'.format(trustkit_alg))
